...
def eval(model, data_eval, voc_size, epoch, model_name):
    # evaluate
    print('')
    model.eval()
    smm_record = []
...
def main(cpu=True, isTest=False, withDDI=False, graph_type='GCN', remove_dm=None, model_name='GAMENet', resume_name=''):
    ...
    if TEST:
        ...
        for epoch in range(EPOCH):
            ...
            ddi_rate, ja, prauc, avg_p, avg_r, avg_f1 = eval(model, data_eval, voc_size, epoch, model_name=model_name)
